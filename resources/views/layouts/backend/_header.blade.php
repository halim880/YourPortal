          ...
          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
            ...
            <li class="nav-item dropdown"> <a class="nav-link text-white" id="notifications" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <ul class="dropdown-menu dropdown-menu-end mt-3 shadow-sm" aria-labelledby="notifications">
                ...
                <li><a class="dropdown-item py-3" href="{{route('bussiness.application.show', $notification['data']['aplication_id'])}}"> 
                    <div class="d-flex">
                      ...
                      <div class="ms-3"><span class="h6 d-block fw-normal mb-1 text-xs text-gray-600">
                        ...
                        <small class="small text-gray-600">1 min ago</small></div>
                    </div></a></li>
