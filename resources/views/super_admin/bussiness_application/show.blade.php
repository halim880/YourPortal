...
@section('content')
    <div class="">
        <div class="container">
            ...
            <a href="{{route('bussiness_application.approve', $application)}}" class="approve-btn">Approve</a>
            <a href="{{route('bussiness_application.approve', $application)}}" class="reject-btn">Reject</a>
        </div>
    </div>
@endsection
