...
@section('content')
    <div class="">
        <div class="container">
            ...
            <a href="{{route('system_admin.member_application.approve', $application)}}" class="approve-btn">Approve</a>
            <a href="{{route('system_admin.member_application.approve', $application)}}" class="reject-btn">Reject</a>
        </div>
    </div>
@endsection
